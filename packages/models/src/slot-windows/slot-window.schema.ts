...
export const createSlotWindowTemplateSchema = z.object({
  user_id: z.string(),
  day_of_week: z.array(DayOfWeekEnum),
  start_time: z.string(),
  end_time: z.string(),
...
export const updateSlotWindowTemplateSchema = z.object({
...
export const createSlotWindowSchema = z.object({
...
export const updateSlotWindowSchema = z.object({
